...
device='cpu'
text_to_mel = TextToMel(glow_model_dir='/home/neeraj/speech-to-speech/tts_ckps/male/glow_ckp', device=device)
mel_to_wav = MelToWav(hifi_model_dir='/home/neeraj/speech-to-speech/tts_ckps/male/hifi_ckp', device=device)
print('TTS male loaded')
